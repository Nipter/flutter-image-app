      ...
      if (mounted) {
        if (error.code == 'email-already-in-use') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(error.message ?? 'Email already used.'),
            ),
          );
        }
        ScaffoldMessenger.of(context).clearSnackBars();
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                if (value == null ||
                                    ...
                                    value.trim().length <=
                                        MIN_USERNAME_LENGTH) {
                                  return 'Please enter at least $MIN_USERNAME_LENGTH characters.';
                                }
                                return null;
                              },
                              onSaved: (value) {
                          ...
                          TextFormField(
                            ...
                            validator: (value) {
                              if (value == null ||
                                ...
                                return 'Password must be at least $MIN_USERNAME_LENGTH characters long.';
                              }
                              return null;
                            },
                            onSaved: (value) {
